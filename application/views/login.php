...
<head>
    <title>CUTI Mahasiswa | Login</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="<?= base_url();?>assets/kk.png" />
    <!--===============================================================================================-->
        ...
        <div class="container-login100">
            <div class="wrap-login100" style="padding:100px 130px 33px 95px;">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="<?= base_url();?>assets/login/images/kk.png" alt="IMG">
                </div>
                ...
                <form class="login100-form validate-form" action="<?= base_url();?>Login/proses" method="POST">
                    ...
                    <br>
                    <p>Jika belum terdaftar <a href="<?= base_url();?>Register/index" style="color:aqua;">register</a></p>
                </form>
            </div>
        </div>
    </div>
