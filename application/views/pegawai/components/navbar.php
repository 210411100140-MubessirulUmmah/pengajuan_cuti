            ...
            <div class="modal-body">
                ...
                <form action="<?= base_url();?>Settings/lengkapi_data" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="alamat" name="alamat" aria-describedby="alamat" value="<?=$alamat?>" required>
                    </div>
                    <div class="form-group">
                        <label for="semester">Semester</label>
                        <input type="text" class="form-control" id="semester" name="semester" aria-describedby="semester" value="<?=$semester?>" required>
                    </div>
                    <div class="form-group">
                        <label for="fakultas">Fakultas</label>
                        <input type="text" class="form-control" id="fakultas" name="fakultas" aria-describedby="fakultas" value="<?=$fakultas?>" required>
                    </div>
                    <div class="form-group">
                        <label for="no_telp">Prodi</label>
                        <textarea class="form-control" id="prodi" rows="3" name="prodi" required><?=$prodi?></textarea>
                    </div>
