...
class Pegawai extends CI_Controller {
	...
	public function tambah_pegawai()
	{
        ...
        $id = md5($username.$email.$password);
            ...
            $hasil = $this->m_user->insert_pegawai($id, $username, $email, $password, $id_user_level, $nama_lengkap, $id_jenis_kelamin, $no_telp, $prodi);
	...
	public function edit_pegawai()
	{
        ...
        $id = $this->input->post("id_user");
            ...
            $hasil = $this->m_user->update_pegawai($id, $username, $email, $password, $id_user_level, $nama_lengkap, $id_jenis_kelamin, $no_telp, $prodi);
