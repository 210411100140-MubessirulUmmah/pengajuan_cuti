...
class Cuti extends CI_Controller {
	...
	public function view_fakultas()
	{
		if ($this->session->userdata('logged_in') == true AND $this->session->userdata('id_user_level') == 4) {
			...
			$data['cuti'] = $this->m_cuti->get_all_cuti_diterima()->result_array();
			$this->load->view('fakultas/cuti', $data);
	...
	public function edit_cuti_admin()
	{
		...
		$hasil = $this->m_cuti->update_cuti($id_cuti, $bukti_pembayaran);
	...
	public function edit_cuti_super_admin()
	{
		$id_cuti = $this->input->post("id_cuti");
		// $prodi = $this->input->post("prodi");
		...
		$surat_ortu = $this->input->post("surat_ortu");
		$surat_kebenaran = $this->input->post("surat_kebenaran");

		$hasil = $this->m_cuti->update_cuti_bak($perihal_cuti, $tgl_diajukan, $mulai, $id_cuti, $surat_ortu, $surat_kebenaran);
