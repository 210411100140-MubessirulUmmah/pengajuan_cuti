...
class M_user extends CI_Model
{
    ...
    public function update_user_detail($id, $nama_lengkap, $id_jenis_kelamin, $no_telp, $prodi, $alamat, $semester, $fakultas)
    {
       $this->db->trans_start();

       
       $this->db->query("UPDATE user_detail SET nama_lengkap='$nama_lengkap', id_jenis_kelamin='$id_jenis_kelamin' ,no_telp='$no_telp', prodi='$prodi', alamat='$alamat', semester='$semester', fakultas='$fakultas' WHERE id_user_detail='$id'");
    ...
    public function insert_pegawai($id, $username, $email, $password, $id_user_level, $nama_lengkap, $id_jenis_kelamin, $no_telp, $prodi)
    {
       $this->db->trans_start();

       $this->db->query("INSERT INTO user(id_user,username,password,email,id_user_level, id_user_detail) VALUES ('$id','$username','$password','$email','$id_user_level','$id')");
       $this->db->query("INSERT INTO user_detail(id_user_detail, nama_lengkap, id_jenis_kelamin, no_telp, prodi) VALUES ('$id','$nama_lengkap','$id_jenis_kelamin','$no_telp','$prodi')");
    ...
    public function update_pegawai($id, $username, $email, $password, $id_user_level, $nama_lengkap, $id_jenis_kelamin, $no_telp, $prodi)
    {
       $this->db->trans_start();
       ...
       $this->db->query("UPDATE user_detail SET nama_lengkap='$nama_lengkap', id_jenis_kelamin='$id_jenis_kelamin' ,no_telp='$no_telp', prodi='$prodi' WHERE id_user_detail='$id'");
